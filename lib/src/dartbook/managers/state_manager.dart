...
//					break;
    ...
    if (this.getState(item) == StateManager.LAST_STATE) {
      item.removeEventListener(LifecycleEvent.INIT_COMPLETE, this.updateState);
      //item.removeEventListener(LifecycleEvent.INIT_START, this.updateState);
      item.removeEventListener(LifecycleEvent.LOAD_COMPLETE, this.updateState);
    }
  }
   ...
   * @
   */
  void setState(BoxSprite item, int state) {
